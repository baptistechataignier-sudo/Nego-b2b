...
<execution_context>
@/home/user/Nego-b2b/.claude/get-shit-done/workflows/manager.md
...
<process>
Execute the manager workflow from @/home/user/Nego-b2b/.claude/get-shit-done/workflows/manager.md end-to-end.
