...
Reference full template: `/home/user/Nego-b2b/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/user/Nego-b2b/.claude/get-shit-done/templates/state.md`.
