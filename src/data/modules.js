...
export const SIMULATIONS = [
  ...
  },
  {
    ...
    color: 'from-purple-500 to-purple-700',
    locked: false,
    context: 'Vous êtes commercial chez AVTech Solutions. La DSI de MédiaCorp veut équiper 5 salles de conférence avec des systèmes audiovisuels premium : écrans 85", visioconférence 4K, sonorisation. Votre devis : 92 000 €. Objectif : conclure au minimum à 80 000 €.',
    buyerProfile: {
      name: 'Sophie Renard',
      title: 'Responsable Achats Équipements',
      avatar: '💼',
      style: 'Acheteur expérimenté, utilise la comparaison tarifaire et les délais comme leviers. Objectif affiché : -20 % minimum.',
      batna: 'Devis TechVision à 74 000 € (installation non incluse, garantie 1 an)',
    },
    steps: [
      {
        id: 0,
        buyerMessage: '"Votre devis est à 92 000 €. J\'ai un concurrent à 74 000 € pour un périmètre qu\'il me dit équivalent. C\'est 24 % d\'écart. Soit vous vous alignez sur ce niveau, soit je ne vois pas comment on avance."',
        options: [
          {
            text: '"74 000 €, je ne peux pas m\'aligner sur ce niveau pour ce périmètre, mais je vous propose qu\'on regarde ensemble ce que chaque devis inclut vraiment — installation, garantie, support post-installation — avant de comparer les prix."',
            quality: 'good',
            feedback: '✅ Excellente réponse ! Vous refusez l\'ancrage adverse sans attaquer le concurrent. Vous déplacez la comparaison du prix vers le périmètre total, ce qui est votre terrain fort.',
            score: 25,
            nextBuyerMessage: '"D\'accord, expliquons. Qu\'est-ce que votre devis inclut que TechVision n\'inclut pas ?"',
          },
          {
            text: '"74 000 €, je vais voir ce que je peux faire."',
            quality: 'bad',
            feedback: '❌ Vous acceptez implicitement l\'ancrage à 74 000 €. Toute la négociation se jouera autour de ce chiffre — vous avez perdu 18 000 € de marge de manœuvre avant même d\'argumenter.',
            score: 0,
            nextBuyerMessage: '"Très bien, alors vous pouvez faire 74 000 ?"',
          },
          {
            text: '"TechVision à 74 000 €, c\'est peu crédible pour ce périmètre — leur qualité n\'est pas comparable."',
            quality: 'ok',
            feedback: '⚠️ Dénigrer un concurrent peut se retourner contre vous. Mieux vaut démontrer votre valeur différentielle par les faits que par des jugements de valeur.',
            score: 10,
            nextBuyerMessage: '"Votre concurrent est crédible pour moi. Qu\'est-ce que vous avez de plus ?"',
          },
        ],
      },
      {
        ...
        options: [
          {
            text: '"Notre devis inclut l\'installation complète (3 jours, 2 techniciens), la garantie 3 ans pièces et main d\'œuvre, et 2 jours de formation de vos équipes. TechVision facture ça en sus. Leur devis nu devient 74 000 + 8 000 d\'install + 3 000 de formation = 85 000 € — soit seulement 7 000 € de différence pour 3 ans de tranquillité supplémentaire."',
            quality: 'good',
            feedback: '✅ Parfait ! Vous présentez un TCO (coût total) comparatif précis et chiffré. Vous réduisez l\'écart perçu de 18 000 € à 7 000 €, et repositionnez la décision sur la durée, pas sur l\'achat initial.',
            score: 30,
            nextBuyerMessage: '"C\'est un argument. Mais 85 000 €, c\'est toujours au-dessus de mon enveloppe de 80 000 €."',
          },
          {
            text: '"On a une meilleure qualité d\'image et nos équipements durent plus longtemps."',
            quality: 'ok',
            feedback: '⚠️ Argument qualitatif valide mais non chiffré. Sans preuve concrète ou comparaison TCO, cela reste subjectif. Quantifiez : durée de vie, coût de remplacement, économies.',
            score: 10,
            nextBuyerMessage: '"C\'est ce que dit tout le monde. Vous avez des preuves ?"',
          },
          {
            text: '"Je peux faire un effort : 86 000 €."',
            quality: 'bad',
            feedback: '❌ Concession trop rapide sans avoir posé votre valeur différentielle. Vous avancez vers 74 000 € sans contrepartie. L\'acheteur va continuer à pousser.',
            score: 0,
            nextBuyerMessage: '"C\'est un début. Poussez à 80 000 € et on a un deal."',
          },
        ],
      },
      {
        ...
        options: [
          {
            text: '"80 000 €, c\'est faisable si on ajuste légèrement le périmètre : on passe à des écrans 75" au lieu des 85" dans les 2 salles secondaires. La qualité reste premium, vous économisez 5 500 €, et on garde l\'installation et la garantie 3 ans complètes. Pour les salles principales, on maintient les 85"."',
            quality: 'good',
            feedback: '✅ Excellent closing ! Vous atteignez 80 000 € en réduisant le périmètre (pas la marge) de façon visible et justifiée. Le client obtient son budget, vous protégez votre rentabilité, et la valeur est maintenue sur l\'essentiel.',
            score: 30,
            nextBuyerMessage: '"75" dans les salles secondaires, c\'est raisonnable. Préparez le bon de commande à 80 000 €."',
          },
          {
            text: '"D\'accord pour 80 000 €, tout compris."',
            quality: 'ok',
            feedback: '⚠️ Vous atteignez votre plancher sans contrepartie. La concession est justifiée par la relation mais vous n\'obtenez rien en échange. Préférez une réduction de périmètre pour justifier la baisse.',
            score: 15,
            nextBuyerMessage: '"Très bien, 80 000 €. Je vous envoie le bon de commande."',
          },
          {
            text: '"80 000 €, c\'est vraiment mon minimum absolu, je ne peux pas faire mieux."',
            quality: 'bad',
            feedback: '❌ Cette formule sonne comme une concession supplémentaire possible. "Minimum absolu" invite à tester encore. Mieux vaut proposer une contrepartie précise pour ancrer le 80 000 €.',
            score: 5,
            nextBuyerMessage: '"78 000 € et on signe ce soir ?"',
          },
        ],
      },
    ],
  },
  {
    ...
    color: 'from-emerald-500 to-green-700',
    locked: false,
    context: 'Votre entreprise a été présélectionnée pour équiper en informatique une collectivité territoriale : 500 postes, infrastructure réseau, serveurs. Montant de votre offre initiale : 285 000 €. Vous êtes en négociation finale avec 2 concurrents. Objectif : conclure au-dessus de 255 000 €.',
    buyerProfile: {
      name: 'Jean-Paul Dumont',
      title: 'DSI — Collectivité de Loire-Atlantique',
      avatar: '🏛️',
      style: 'Acheteur public rigoureux. Soumis aux règles des marchés publics, sensible à la traçabilité et aux garanties. Cherche à valoriser l\'économie réalisée auprès de l\'élu.',
      batna: '2 concurrents présélectionnés ; le moins cher est à 262 000 € (matériel de génération précédente)',
    },
    steps: [
      {
        id: 0,
        buyerMessage: '"On est en négociation finale. Vos deux concurrents ont consenti des rabais supplémentaires depuis la remise des offres. Pour que je puisse défendre votre dossier en commission, j\'ai besoin d\'une offre finale améliorée. Qu\'est-ce que vous proposez ?"',
        options: [
          {
            text: '"Je comprends la contrainte de la commission. Avant de parler d\'un rabais supplémentaire, j\'aimerais qu\'on valide ensemble que notre offre est bien comparée à périmètre égal avec les autres : nos matériels sont de dernière génération, avec une garantie 4 ans sur site. Pouvez-vous me confirmer les éléments précis sur lesquels porte la comparaison ?"',
            quality: 'good',
            feedback: '✅ Stratégique ! Vous ne cédez pas immédiatement sur le prix. Vous questionnez la comparabilité des offres avant de négocier — essentiel en appel d\'offres où les écarts de périmètre sont fréquents.',
            score: 25,
            nextBuyerMessage: '"La commission compare sur le prix total TTC. Votre concurrent principal est à 262 000 €. Qu\'est-ce que vous pouvez faire ?"',
          },
          {
            text: '"Je peux faire un effort commercial de 10 000 € pour soutenir votre dossier."',
            quality: 'ok',
            feedback: '⚠️ Concession trop rapide sans avoir qualifié la comparaison. 10 000 € est acceptable mais vous auriez pu d\'abord défendre la différence de valeur entre les offres.',
            score: 10,
            nextBuyerMessage: '"10 000 €, c\'est un début. Mais 275 000 €, c\'est encore au-dessus. Poussez à 260 000 €."',
          },
          {
            text: '"Notre offre est la meilleure du marché, je ne peux pas aller plus bas."',
            quality: 'bad',
            feedback: '❌ Position rigide sans argumentation sur la valeur. Dans un appel d\'offres public, refuser toute discussion peut vous éliminer directement. Il faut rester dans le dialogue.',
            score: 0,
            nextBuyerMessage: '"Dans ce cas, je vais devoir travailler avec vos concurrents."',
          },
        ],
      },
      {
        ...
        options: [
          {
            text: '"262 000 € pour notre concurrent correspond à du matériel N-1, sans garantie sur site et avec une migration à votre charge dans 3 ans. Sur 5 ans, votre coût total avec nous est inférieur : 285 000 € + 0 € de migration vs 262 000 € + ~40 000 € de renouvellement anticipé. Je peux aller à 270 000 € avec extension de garantie à 5 ans incluse."',
            quality: 'good',
            feedback: '✅ Excellent argument TCO ! Vous chiffrez l\'avantage sur 5 ans et proposez une contrepartie (garantie 5 ans) qui justifie l\'écart résiduel de 8 000 €. La commission peut défendre ce choix objectivement.',
            score: 30,
            nextBuyerMessage: '"L\'argument sur le coût total est intéressant. 270 000 € avec garantie 5 ans... je dois voir avec l\'élu. C\'est votre meilleure offre ?"',
          },
          {
            text: '"Je peux aller à 268 000 €, mais c\'est vraiment mon plancher."',
            quality: 'ok',
            feedback: '⚠️ Vous approchez du plancher sans avoir maximisé la défense de valeur. La concession est directe sans contre-argumentation sur le TCO, ce qui fragilise votre position pour la suite.',
            score: 12,
            nextBuyerMessage: '"268 000 €... si vous faites 260 000 €, c\'est dans l\'enveloppe et je peux défendre ça en commission."',
          },
          {
            text: '"Je peux baisser à 260 000 € pour sécuriser le marché."',
            quality: 'bad',
            feedback: '❌ Vous êtes descendu sous votre plancher de 255 000 €. Une telle concession sans contrepartie laisse penser que votre offre initiale était surévaluée — et peut même générer des questions légales en marché public.',
            score: 0,
            nextBuyerMessage: '"260 000 €, c\'est dans notre enveloppe. On peut avancer."',
          },
        ],
      },
      {
        ...
        options: [
          {
            text: '"C\'est mon offre finale : 270 000 € avec garantie 5 ans sur site, migration incluse et formation de vos équipes IT (valeur 8 000 €). Pour la commission, vous pouvez présenter une économie de 15 000 € vs offre initiale ET un coût total sur 5 ans inférieur aux alternatives. C\'est un dossier solide."',
            quality: 'good',
            feedback: '✅ Closing expert ! Vous maintenez votre position (au-dessus du plancher), vous ajoutez de la valeur sans baisser le prix (formation incluse), et vous aidez le DSI à "vendre" le choix en commission avec des arguments concrets. C\'est du vrai partenariat.',
            score: 35,
            nextBuyerMessage: '"La formation incluse, c\'est un plus réel. Je vais présenter ça à l\'élu. Je reviens vers vous d\'ici 48h."',
          },
          {
            text: '"Oui, 270 000 € est ma meilleure offre. Je ne peux pas aller plus bas."',
            quality: 'ok',
            feedback: '⚠️ Vous tenez votre position, ce qui est bien. Mais vous ratez l\'opportunité d\'ajouter de la valeur (formation, extension) qui rendrait la décision plus facile pour la commission sans toucher à votre marge.',
            score: 15,
            nextBuyerMessage: '"D\'accord. Je vais présenter ça à la commission. On vous revient."',
          },
          {
            text: '"Écoutez, pour sécuriser ce marché, je peux faire 258 000 €, tout compris."',
            quality: 'bad',
            feedback: '❌ Concession de dernière minute sous pression non justifiée. Vous êtes sous votre plancher ET vous signalez que toutes vos positions précédentes n\'étaient pas fermes. Dans un marché public, cela peut même poser des questions de conformité.',
            score: 0,
            nextBuyerMessage: '"258 000 €, ça rentre dans l\'enveloppe. On transmet en commission."',
          },
        ],
      },
    ],
